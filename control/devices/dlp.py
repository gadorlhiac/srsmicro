"""!
@brief Definition of the Dlp class for interacting with the Texas Instruments
DMD.
"""

from .device import Device
# from .wrappers.dlpwrapper import DlpWrapper
from PyQt5.QtCore import pyqtSignal as Signal

class Dlp(Device):
    """! See description of Kcube.
    """

    def __init__(self, name='Insight'):
        """! The Dlp class initializer.
        """
        super().__init__(name)
