"""!
@brief Definition of the Kcube class for interacting with Thorlabs Kcubes.
"""

from .device import Device
# from .wrappers.kcubewrapper import KcubeWrapper
from PyQt5.QtCore import pyqtSignal as Signal

class Kcube(Device):
    """! The Kcube class controls Thorlabs' KCube motors. This class conforms to
    the Device class structure of every other device in the microscope ecosystem
    of the controller software. The associated KcubeWrapper is a Cython wrapper
    class for the underlying C++ code that actually interacts with the device.
    An instance is held by this class. The KcubeWrapper could alternatively be
    interacted with through Python directly; however, **it is not** structured
    for easy integration into the GUI, which is why this class exists.
    """
