...
#if defined(ZI_API_EXPERIMENTAL)

/** @defgroup Transactions Transactional commands
 *  @brief Functions for handling transactional set commands.
 *
 *  @warning The functions in here are experimental and may break without
 *  further notice. You may opt in to use these functions through definition of
 *  ZI_API_EXPERIMENTAL.
 */
